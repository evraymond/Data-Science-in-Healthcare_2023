...
M_L6 = readmatrix("df_days_in_past_30_had_alcoholic_drink_L1_nodrinks.csv");
M_L7 = readmatrix("df_days_in_past_30_had_alcoholic_drink_L2_1dayPerWeek.csv");
M_L8 = readmatrix("df_days_in_past_30_had_alcoholic_drink_L3_daysin30.csv");
...
X = {M_L6(2:end, [2:end-1]), M_L7(2:end, [2:end-1]), M_L8(2:end, [2:end-1])}
Y = {M_L6(2:end, end), M_L7(2:end, end), M_L8(2:end, end)}
%X = M(:, [2:50 52:end]);
%Y = M(:, 51);
...
writematrix(W_toCsv,'W_MTL_Least_L21__ALCDAY5.xlsx');
