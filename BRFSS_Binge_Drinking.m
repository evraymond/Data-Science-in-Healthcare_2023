...
M_L4 = readmatrix("df_binge_drinking_calculated_variable_L1_no.csv");
M_L5 = readmatrix("df_binge_drinking_calculated_variable_L2_yes.csv");
...
X = {M_L4(2:end, [2:end-1]), M_L5(2:end, [2:end-1])}
Y = {M_L4(2:end, end), M_L5(2:end, end)}
%X = M(:, [2:50 52:end]);
%Y = M(:, 51);
...
writematrix(W_toCsv,'W_MTL_Least_L21__RFBING5.xlsx');
...
%%
W_toCsv = [(0:size(W,1)-1)' W];
writematrix(W_toCsv,'W_MTL_Least_L21__RFBING5_STATES.xlsx');